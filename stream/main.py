...
def get_exchange_info() -> list[dict]:
    ...
    Note:
        ...
        - Excludes symbols where the base asset is a stablecoin (specified in 'stable_coins').
        - Excludes symbols where the quote asset is a stablecoin (specified in 'stable_coins').
...
async def cleanup():
    ...
    at fixed intervals. It uses asyncio's `sleep` function to pause execution for
